...
// @file	:	Matrix_Module
// @author	:	NAGISA
// @data	:	2023/1/27 20:49:32
// @brief	:	
//==========================================================================================================
#pragma once

#ifndef __HEAD_Matrix_Module
#define __HEAD_Matrix_Module
...
public:
    ...
    */
    ...
    __this_ref Rotate(_TYP FLOAT32 radian) {
        _TYP FLOAT32 sin = Sin(radian);
        _TYP FLOAT32 cos = Cos(radian);
        __this copy = *this;
    ...
    __this_ref Tilt(_TYP FLOAT32 skewx, _TYP FLOAT32 skewy) {
        __num 
            a_ = a, 
            b_ = b, 
            c_ = c,
            d_ = d;
        _TYP FLOAT32 tanx = Tan(skewx), tany = Tan(skewy);
...
public:
    ...
    __num ty;
public:
    NGS_INL_CSTEXPR static const __num u = 0;
    NGS_INL_CSTEXPR static const __num v = 0;
    NGS_INL_CSTEXPR static const __num w = 1;
